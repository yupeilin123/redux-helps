...
var staticNamespace = "reduxHelps@1.0.0.".concat(randomString());
/**
 * 
...
function transformSaga(rootSaga) {
  var sagas = {};

  if (Object.prototype.hasOwnProperty.call(rootSaga, 'namespace')) {
    var namespace = rootSaga.namespace,
        handles = _objectWithoutProperties(rootSaga, ["namespace"]);
